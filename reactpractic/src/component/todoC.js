      ...
      <div className='container mt-2 '>
        ...
        <div className='row mb-4'>
          <div className='col-md-2'>
            <button onClick={() => this.setState({ selectedStatus: "active" })} className=' btn btn-info'>Active</button>
          </div>
          <div className='col-md-2'>
            <button onClick={() => this.setState({ selectedStatus: "deactivate" })} className=' btn btn-info'>Deactive</button>
          </div>
        </div>
